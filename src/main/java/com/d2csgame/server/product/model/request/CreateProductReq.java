...
public class CreateProductReq {
    ...
    @Min(value = 0, message = "Primary image index must be a valid index")
    @Max(value = 10, message = "Primary image index must be within the allowed range")
    private Integer isPrimaryIndex;
}
