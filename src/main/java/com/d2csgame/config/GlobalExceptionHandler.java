...
import com.d2csgame.exception.InvalidDataException;
import com.d2csgame.exception.ResourceNotFoundException;
import com.d2csgame.model.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ConstraintViolationException.class,
            MissingServletRequestParameterException.class, MethodArgumentNotValidException.class, BadRequestException.class})
                                    ...
                                    value = """
                                            {
                                              ...
                                              "path": "/api/v1/...",
                                              "error": "Access denied",
                                              "message": "Access denied, please try login again"
                                            }
                                            """
                            ))})
    })
